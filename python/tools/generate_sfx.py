...
効果音ID(5種。telop_presets.yaml の sfx / type マッピングの sfx が参照する):
...
Usage:
    .venv/bin/python python/tools/generate_sfx.py
"""
...
def generate_sfx(output_dir: Path = ASSETS_SFX_DIR, copy_dir: Path | None = REMOTION_SFX_DIR) -> list[Path]:
    """全効果音を生成し、生成したwavのパス一覧を返す。ffmpeg必須。"""
