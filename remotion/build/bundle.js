...
const OVERLAY_POSITIONS = ["top_left", "bottom_left", "center", "bottom"];
...
const isOverlayType = (value) => typeof value === "string" && OVERLAY_TYPES.includes(value);
const isOverlayPosition = (value) => typeof value === "string" && OVERLAY_POSITIONS.includes(value);
function normalizeOverlays(raw) {
  ...
  for (let i = 0; i < raw.length; i += 1) {
    ...
    items.push({
      ...
      lines: Array.isArray(entry.lines) ? entry.lines.filter((line) => typeof line === "string") : void 0,
      subtitle: typeof entry.subtitle === "string" ? entry.subtitle : void 0,
      position: isOverlayPosition(entry.position) ? entry.position : DEFAULT_OVERLAY_POSITION[entry.type],
      style: typeof entry.style === "string" ? entry.style : void 0
    });
  }
  return items;
}
function isOverlayActive(item, timelineMs) {
  return timelineMs >= item.start_ms && timelineMs < item.end_ms;
}
function overlayLines(item) {
  if (item.lines && item.lines.length > 0) return item.lines;
  return item.text ? [item.text] : [];
}

;// ./src/lib/telopGlow.ts

const round2 = (value) => Math.round(value * 100) / 100;
function buildGlowFilter(glow, scale) {
...
function combineTelopFilters(...parts) {
  const present = parts.filter((part) => Boolean(part));
  return present.length ? present.join(" ") : void 0;
}

;// ./src/lib/overlayStyles.ts


const OVERLAY_GOTHIC_FONT_FAMILY = '"Zen Kaku Gothic Antique", "Hiragino Kaku Gothic ProN", "Hiragino Sans", "Meiryo", sans-serif';
const OVERLAY_MINCHO_FONT_FAMILY = '"Hiragino Mincho ProN", "Hiragino Mincho Pro", "Yu Mincho", serif';
const PROFILE_CARD_BOTTOM_PX = 300;
const CTA_BANNER_BOTTOM_PX = 290;
function overlayPositionStyle(position, scale, type) {
  const base = { position: "absolute", display: "flex" };
  switch (position) {
    case "top_left":
...
function resolveOverlayTextStyle(item, styles, defaults) {
  var _a, _b;
  const preset = item.style ? styles == null ? void 0 : styles[item.style] : void 0;
  ...
  return {
    ...
    strokeColor: ((_a = preset.outer_stroke) == null ? void 0 : _a.color) ?? ((_b = preset.inner_stroke) == null ? void 0 : _b.color) ?? defaults.strokeColor
  };
}
const CHAPTER_TITLE_DEFAULTS = {
  fontFamily: OVERLAY_MINCHO_FONT_FAMILY,
  fillColor: "#111111",
  strokeColor: "#FFFFFF"
};
const CHAPTER_TITLE_FILTER = "drop-shadow(0px 3px 5px rgba(0,0,0,0.5))";
function chapterTitleTextSpec(scale, resolved) {
  return {
    fontSize: 46 * scale,
...
const DEFAULT_CHAPTER_TITLE_PATTERN = "box_accent";
function resolveChapterTitlePattern(style) {
  return CHAPTER_TITLE_PATTERNS.includes(style ?? "") ? style : DEFAULT_CHAPTER_TITLE_PATTERN;
}
const TITLE_BAND_NAVY = "23,48,94";
const TITLE_BAND_ACCENT = "#FFC400";
const TITLE_RIBBON_RED = "#C7362F";
const TITLE_NEON_CYAN = "#54FFFF";
function chapterTitleRenderSpec(pattern, scale, resolved) {
  switch (pattern) {
    case "band_gradient":
      return {
...
function profileCardBoxStyle(scale) {
  return {
...
function profileCardNameStyle(scale) {
  return {
    fontFamily: OVERLAY_GOTHIC_FONT_FAMILY,
    fontSize: 44 * scale,
    fontWeight: 800,
...
function profileCardSubtitleStyle(scale) {
  return {
    fontFamily: OVERLAY_GOTHIC_FONT_FAMILY,
    fontSize: 21 * scale,
    fontWeight: 700,
...
function listStackContainerStyle(scale) {
  return {
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
...
function listStackLineStyle(scale) {
  return {
...
function ctaBannerBoxStyle(scale) {
  return {
...
function ctaBannerLineStyle(scale) {
  return {
    color: "#000000",
    fontFamily: OVERLAY_GOTHIC_FONT_FAMILY,
    fontSize: 58 * scale,
...
const CAPTION_FILTER = "drop-shadow(0px 3px 6px rgba(0,0,0,0.45))";
function captionTextSpec(scale, resolved) {
  return {
    fontSize: 58 * scale,
    fontFamily: resolved.fontFamily,
    fontWeight: 900,
...
function strokeTextBaseStyle(spec) {
  return {
...
const StrokeText = ({ text, spec }) => {
  const base = strokeTextBaseStyle(spec);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "relative", display: "inline-block" }, children: [
    spec.strokeWidth > 0 && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
...
const ChapterTitle = ({
  ...
  const inner = /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(StrokeText, { text: item.text ?? "", spec: spec.text }),
    spec.underline && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: spec.underline })
  ] });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: spec.container, children: spec.plate ? /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: spec.plate, children: inner }) : inner });
};
const ProfileCard = ({ item, scale }) => {
  const subtitleLines = (item.subtitle ?? "").split("\n").filter((line) => line.length > 0);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: profileCardBoxStyle(scale), children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: profileCardNameStyle(scale), children: item.text ?? "" }),
    subtitleLines.map((line, idx) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: profileCardSubtitleStyle(scale), children: line }, idx))
  ] });
};
const ListStack = ({ item, scale }) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: listStackContainerStyle(scale), children: overlayLines(item).map((line, idx) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: listStackLineStyle(scale), children: line }, idx)) });
const CtaBanner = ({ item, scale }) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: ctaBannerBoxStyle(scale), children: overlayLines(item).map((line, idx) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: ctaBannerLineStyle(scale), children: line }, idx)) });
const Caption = ({
  item,
  scale,
  styles
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { filter: CAPTION_FILTER }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StrokeText, { text: item.text ?? "", spec: captionTextSpec(scale, resolved) }) });
};
const OverlayContent = ({
  ...
  switch (item.type) {
    case "chapter_title":
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(ChapterTitle, { item, scale, styles });
    case "profile_card":
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(ProfileCard, { item, scale });
    case "list_stack":
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(ListStack, { item, scale });
    case "cta_banner":
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(CtaBanner, { item, scale });
    case "caption":
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(Caption, { item, scale, styles });
  }
};
const Overlays = ({
  overlays,
  ...
  const { fps, height } = (0,esm/* useVideoConfig */.Bk)();
  const items = normalizeOverlays(overlays);
  if (items.length === 0) return null;
  const scale = height / 1080;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { pointerEvents: "none" }, children: items.map((item) => {
    const from = Math.round(item.start_ms / 1e3 * fps);
    const durationInFrames = Math.max(
      1,
      Math.round((item.end_ms - item.start_ms) / 1e3 * fps)
    );
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Sequence */.gd, { from, durationInFrames, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: overlayPositionStyle(item.position, scale, item.type), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(OverlayContent, { item, scale, styles }) }) }, item.id);
  }) });
};

;// ./src/lib/telopHighlight.ts

const DEFAULT_HIGHLIGHT_COLOR = "#E7305B";
function splitHighlightRuns(lineText, highlightWords) {
  if (!lineText) return [];
...
const SINGLE_PARTICLES = /* @__PURE__ */ new Set([..."\u306F\u304C\u3092\u306B\u3067\u3068\u3082\u3078\u3084\u306E\u304B\u306D\u3088\u3070\u3055\u305E"]);
const CLOSING_CHARS = /* @__PURE__ */ new Set([..."\u3002\u3001\uFF0E\uFF0C\uFF01\uFF1F!?\u2026\u2025\u300D\u300F\uFF09)\u3011\u3009\u300B"]);
const PHRASE_END_CHARS = /* @__PURE__ */ new Set([..."\u306F\u304C\u3092\u306B\u3067\u3068\u3082\u3078\u3084\u306E\u304B\u306D\u3088\u3070\u3055\u305E\u3066\u3057\u304F\u306A"]);
function isHiragana(ch) {
  return ch >= "\u3041" && ch <= "\u3093" || ch === "\u30FC";
}
function dependentHeadLength(text) {
  if (!text) return 0;
...
const SMALL_KANA = /* @__PURE__ */ new Set(["\u3041", "\u3043", "\u3045", "\u3047", "\u3049", "\u3083", "\u3085", "\u3087"]);
const ASCII_PUNCT = /* @__PURE__ */ new Set(["!", "?", ",", ".", "-", "'", '"']);
const HEAD_FORBIDDEN = /* @__PURE__ */ new Set([..."\u3001\u3002\uFF01\uFF1F!?\u2026\u2025\u30FB:;\uFF09)\u300D\u300F\u3011\u3009\u300B\uFF3D"]);
...
function wrapTelopLine(text, budget, maxLines) {
...
function wrapTelopLineAtBudget(text, budget) {
  if (!text) return [];
  ...
  for (let i = n - 1; i >= 0; i -= 1) {
    ...
    for (let j = i + 1; j <= n; j += 1) {
      ...
      if (j < n) {
        ...
        if (nextHead !== void 0 && HEAD_FORBIDDEN.has(nextHead)) cost += KINSOKU_COST;
...
;// ./src/lib/telopLayout.ts


const TELOP_MAX_LINES = 2;
const TELOP_ABSOLUTE_MAX_LINES = 3;
const TELOP_MIN_FONT_SCALE = 0.55;
const VERTICAL_TELOP_MIN_FONT_SCALE = 0.75;
const VERTICAL_TELOP_MIN_FONT_PX = 68;
const TELOP_SAFE_AREA_RATIO = 0.04;
const TELOP_LINE_GAP_PX = 8;
const TELOP_FIT_WIDTH_RATIO = 0.92;
const VERTICAL_TELOP_FIT_WIDTH_RATIO = 0.86;
function telopFitWidth(videoWidth, videoHeight) {
  const ratio = videoHeight > videoWidth ? VERTICAL_TELOP_FIT_WIDTH_RATIO : TELOP_FIT_WIDTH_RATIO;
  return videoWidth * ratio;
}
function wrapSegmentsWithMaxLines(segmentTexts, maxCharsPerLine, totalMaxLines) {
  const texts = segmentTexts.filter((text) => text !== void 0 && text !== null);
...
function fitFontSizeForLines(lineTexts, options) {
...
function computeTelopBlockLayout(options) {
  const {
    segmentTexts,
    maxCharsPerLine,
    baseFontSize,
...
function clampTelopYPercent(options) {
  const {
    telopY,
    yOffset,
    lineCount,
  ...
  const blockHeightPx = lineCount * lineHeight * fontSize + Math.max(0, lineCount - 1) * lineGapPx + blockPaddingY * 2;
...
;// ./src/lib/telopTypography.ts

const DEFAULT_PARTICLE_SCALE = 0.8;
const DEFAULT_LATIN_FONT_FAMILY = '-apple-system, "SF Pro Display", "Helvetica Neue", "Arial", sans-serif';
const PARTICLES = /* @__PURE__ */ new Set(["\u306E", "\u304C", "\u3092", "\u306B", "\u306F", "\u3067", "\u3068", "\u3078", "\u3082", "\u3084"]);
const SOLID_CHAR_RE = /[\u3400-\u4DBF\u4E00-\u9FFF\uF900-\uFAFF々〆ヶヵ\u30A0-\u30FF0-9０-９A-Za-zＡ-Ｚａ-ｚ]/;
const LATIN_CHAR_RE = /[0-9A-Za-z]/;
const LATIN_JOINER_RE = /[.,%+\-:]/;
function computeCharKinds(text) {
  const chars = Array.from(text);
  const kinds = chars.map(() => "normal");
  for (let i = 0; i < chars.length; i += 1) {
    ...
    if (LATIN_JOINER_RE.test(ch) && i > 0 && i < chars.length - 1 && LATIN_CHAR_RE.test(chars[i - 1]) && LATIN_CHAR_RE.test(chars[i + 1])) {
      kinds[i] = "latin";
      continue;
    }
    if (PARTICLES.has(ch) && i > 0 && i < chars.length - 1 && SOLID_CHAR_RE.test(chars[i - 1]) && SOLID_CHAR_RE.test(chars[i + 1])) {
      kinds[i] = "particle";
    }
  }
...
function splitTypographyRuns(text) {
  const chars = Array.from(text);
...
function splitStyledRuns(text, highlightMask) {
  const chars = Array.from(text);
  if (chars.length === 0) return [];
  const kinds = computeCharKinds(text);
  const runs = [];
...
function buildHighlightMask(text, highlightWords) {
  const chars = Array.from(text);
  const mask = chars.map(() => false);
  if (!(highlightWords == null ? void 0 : highlightWords.length)) return mask;
...
const ANIMATION_OUT_TYPES = ["fade", "pop_out", "none"];
const DEFAULT_ANIMATION_DURATION_FRAMES = 12;
const LEGACY_IN_ALIASES = {
  popIn: "zoom",
  fadeIn: "fade",
  stamp: "stamp"
};
const LEGACY_OUT_ALIASES = {
  popOut: "pop_out",
  fadeOut: "fade"
};
function sanitizeAnimationIn(value) {
  if (typeof value !== "string") return null;
  if (ANIMATION_IN_TYPES.includes(value)) return value;
  return LEGACY_IN_ALIASES[value] ?? null;
}
function sanitizeAnimationOut(value) {
  if (typeof value !== "string") return null;
  if (ANIMATION_OUT_TYPES.includes(value)) return value;
  return LEGACY_OUT_ALIASES[value] ?? null;
}
function resolveTelopAnimation(source) {
  const animationIn = sanitizeAnimationIn(source.telopAnimationIn) ?? sanitizeAnimationIn(source.styleAnimationIn) ?? sanitizeAnimationIn(source.timelineAnimationIn) ?? "none";
  const animationOut = sanitizeAnimationOut(source.telopAnimationOut) ?? sanitizeAnimationOut(source.styleAnimationOut) ?? sanitizeAnimationOut(source.timelineAnimationOut) ?? "none";
  const rawDuration = Number(source.styleDurationFrames);
  const durationFrames = Number.isFinite(rawDuration) && rawDuration > 0 ? Math.round(rawDuration) : DEFAULT_ANIMATION_DURATION_FRAMES;
  return { animationIn, animationOut, durationFrames };
}

;// ./src/lib/telopTypewriter.ts
...
const DEFAULT_FONT_FAMILY = '"Zen Kaku Gothic Antique", "Hiragino Kaku Gothic ProN", "Hiragino Sans", "Meiryo", sans-serif';
...
const resolveStyle = (telop, styles, defaultStyleName) => {
...
const getInAnim = (frame, startFrame, type, fps, durationFrames, ctx) => {
  const localFrame = frame - startFrame;
  if (type === "none" || localFrame < 0) return { opacity: 1, transform: "" };
  if (type === "pop_big") {
    const progress = (0,esm/* spring */.oz)({
      frame: localFrame,
      fps,
      config: { damping: 13, stiffness: 160 },
      durationInFrames: durationFrames
    });
    const scale = (0,esm/* interpolate */.GW)(progress, [0, 1], [1.8, 1]);
  ...
  if (type === "zoom") {
    ...
    const scale = (0,esm/* interpolate */.GW)(progress, [0, 1], [0.55, 1]);
    return { opacity: Math.min(1, localFrame / 2), transform: `scale(${scale})` };
  }
  if (type === "stamp") {
    const progress = (0,esm/* spring */.oz)({ frame: localFrame, fps, config: { damping: 8, stiffness: 300 } });
    const scale = (0,esm/* interpolate */.GW)(progress, [0, 1], [2.5, 1]);
    return { opacity: Math.min(1, progress * 3), transform: `scale(${scale})` };
  }
  if (type === "fade") {
    const opacity = (0,esm/* interpolate */.GW)(localFrame, [0, durationFrames], [0, 1], { extrapolateRight: "clamp" });
    return { opacity, transform: "" };
  }
  if (type === "blur_in") {
    const progress = (0,esm/* interpolate */.GW)(localFrame, [0, durationFrames], [0, 1], {
    ...
    return {
      opacity: progress,
      transform: "",
      filter: blur > 0.05 ? `blur(${blur.toFixed(2)}px)` : void 0
    };
  }
  if (type === "wipe_up") {
    const progress = (0,esm/* interpolate */.GW)(localFrame, [0, durationFrames], [0, 1], {
    ...
    return {
      opacity: 1,
      transform: "",
      clipPath: inset > 0.1 ? `inset(${inset.toFixed(2)}% 0% 0% 0%)` : void 0
    };
  }
  if (type === "slam") {
    const progress = (0,esm/* spring */.oz)({
    ...
    const scale = (0,esm/* interpolate */.GW)(progress, [0, 1], [2.2, 1]);
    const settleFrame = localFrame - durationFrames;
    const shakeX = settleFrame >= 0 && settleFrame < 5 ? Math.sin(settleFrame * 2.6) * Math.max(0, 6 - settleFrame * 1.6) : 0;
    return {
      opacity: Math.min(1, localFrame / 2),
...
const getOutAnim = (framesUntilEnd, type) => {
  ...
  if (type === "pop_out") {
    ...
    return {
      opacity: (0,esm/* interpolate */.GW)(progress, [0, 0.3], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }),
      scale: eased
    };
  }
...
const resolveBlockBackground = (style) => style.background && (style.background.padding_x !== void 0 || style.background.padding_y !== void 0) ? style.background : null;
const TelopLayer = ({
  lineTexts,
  fontSize,
  style,
  ...
  const latinFontFamily = style.latin_font_family === null ? null : style.latin_font_family ?? DEFAULT_LATIN_FONT_FAMILY;
  const runSpanStyle = (kind) => {
  ...
  const typewriterActive = typewriterCount !== null && typewriterCount !== void 0;
  const lineStartOffsets = typewriterActive ? typewriterLineOffsets(lineTexts).offsets : null;
  const renderTypewriterText = (text, startIndex) => splitGraphemes(text).map((grapheme, graphemeIdx) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "span",
    {
  ...
  const renderLayerLine = (lineText, lineStart = 0) => {
    ...
    return runs.map((run, runIdx) => {
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: runSpanStyle(run.kind), children: typewriterActive ? renderTypewriterText(run.text, runStart) : run.text }, runIdx);
    });
  };
  const highlightColor = style.highlight_color ?? DEFAULT_HIGHLIGHT_COLOR;
  const renderFillLine = (lineText, lineStart = 0) => {
    ...
    return runs.map((run, runIdx) => {
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "span",
        {
          ...
          children: typewriterActive ? renderTypewriterText(run.text, runStart) : run.text
        },
        runIdx
      );
    });
  };
  const innerStrokeWidth = style.inner_stroke ? Math.round(style.inner_stroke.width * (fontSize / 52)) : 0;
  const outerStrokeWidth = style.outer_stroke ? Math.round(style.outer_stroke.width * (fontSize / 52)) : 0;
  const outerStroke2Width = style.outer_stroke2 ? Math.round(style.outer_stroke2.width * (fontSize / 52)) : 0;
  ...
  const textStyle = {
    ...
    ...isVerticalWriting ? { writingMode: "vertical-rl", textOrientation: "upright" } : {}
  };
  const fillStyle = style.fill.type === "solid" ? { color: style.fill.color ?? "#FFFFFF", textDecoration: style.underline ? "underline" : void 0 } : {
    color: "transparent",
    backgroundImage: gradientCss(style),
    WebkitBackgroundClip: "text",
    backgroundClip: "text"
  };
  const combinedFilter = animFilter && blockFilter ? `${animFilter} ${blockFilter}` : animFilter ?? blockFilter;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
        ...
        backgroundColor: blockBackground == null ? void 0 : blockBackground.color,
        padding: blockBackground ? `${blockBackground.padding_y ?? 0}px ${blockBackground.padding_x ?? 0}px` : void 0,
        borderRadius: blockBackground == null ? void 0 : blockBackground.border_radius
      },
      children: lineTexts.map((lineText, lineIdx) => /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        "div",
        {
          style: {
            position: "relative",
            display: "inline-block",
            backgroundColor: lineBandBackground == null ? void 0 : lineBandBackground.color,
            padding: lineBandBackground ? "0.15em 0.5em" : void 0,
            borderRadius: lineBandBackground == null ? void 0 : lineBandBackground.borderRadius
          },
          children: [
            shadowOffset && /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  ...textStyle,
                  color: shadowOffset.color,
                  WebkitTextStroke: shadowStrokeWidth ? `${shadowStrokeWidth}px ${shadowOffset.color}` : void 0,
                  position: "absolute",
                  inset: 0,
                  transform: `translate(${shadowOffset.x * shadowScale}px, ${shadowOffset.y * shadowScale}px)`
                },
                children: renderLayerLine(lineText, (lineStartOffsets == null ? void 0 : lineStartOffsets[lineIdx]) ?? 0)
              }
            ),
            style.outer_stroke2 && // フェーズU6: 第3縁は最背面(DOM上で最初の通常フローレイヤー)に描画する
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
            ...
            style.outer_stroke && /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  ...textStyle,
            ...
            style.inner_stroke && /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  ...textStyle,
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  ...textStyle,
                  ...fillStyle,
                  position: style.outer_stroke2 || style.outer_stroke || style.inner_stroke ? "absolute" : "relative",
                  inset: 0
                },
                children: renderFillLine(lineText, (lineStartOffsets == null ? void 0 : lineStartOffsets[lineIdx]) ?? 0)
              }
            )
          ]
        },
...
const Telop = ({
  ...
  const { width: videoWidth, height: videoHeight } = (0,esm/* useVideoConfig */.Bk)();
  const globalFontSize = fontSize ?? 52;
  const rawTimings = telops.map((telop) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { children: telopTimings.map((timing) => {
    const { telop, startFrame, displayEnd, segments, style } = timing;
    const isLast = timing === telopTimings[telopTimings.length - 1];
    const isVisible = isLast ? frame >= startFrame && frame <= displayEnd : frame >= startFrame && frame < displayEnd;
    ...
    const layout = isVerticalWriting ? (() => {
      ...
      fitWidth: telopFitWidth(videoWidth, videoHeight) - (blockBackground ? (blockBackground.padding_x ?? 0) * 2 : 0),
      // フェーズW26: 縦型は縮小しすぎる前に2行折返しへ逃がす(文字を大きく保つ)
      minFontScale: videoHeight > videoWidth ? VERTICAL_TELOP_MIN_FONT_SCALE : void 0,
      // フェーズW27: 縦型は絶対最低サイズも張る(ショートはテロップを大きく)
      minFontPx: videoHeight > videoWidth ? VERTICAL_TELOP_MIN_FONT_PX : void 0
    });
    ...
    const typewriterCount = anim.animationIn === "typewriter" ? typewriterVisibleCount(
...
;// ./src/lib/adSafeZone.ts

const TELOP_BAND_TOP = 0.3;
const TELOP_BAND_BOTTOM = 0.72;
const VERTICAL_DEFAULT_TELOP_Y = 0.64;
const LOWER_BAND_TOP = 0.58;
const LOWER_BAND_BOTTOM = 0.72;
const UPPER_BAND_TOP = 0.3;
const UPPER_BAND_BOTTOM = 0.42;
const VERTICAL_UPPER_DEFAULT_TELOP_Y = 0.36;
const FACE_TELOP_MARGIN = 0.03;
const DEFAULT_BLOCK_HEIGHT_RATIO = 0.08;
const clamp = (value, low, high) => Math.max(low, Math.min(high, value));
const validFaceBox = (faceBox) => {
...
function resolveCutTelopY(options) {
  const {
    orientation,
    baseTelopY,
    faceBox = null,
...
function effectiveCutTelopY(cutTelopY, timelineTelopY) {
  return typeof cutTelopY === "number" && Number.isFinite(cutTelopY) && cutTelopY >= 0 && cutTelopY <= 1 ? cutTelopY : timelineTelopY;
}

;// ./src/lib/bgmAudio.ts

const BGM_DEFAULT_VOLUME = 0.15;
const BGM_DEFAULT_FADE_MS = 1500;
const clamp01 = (value) => Math.max(0, Math.min(1, value));
function normalizeBgmTrack(raw) {
  if (!Array.isArray(raw)) return [];
  const clips = [];
...
function bgmVolumeAtMs(clip, msFromClipStart) {
...
function bgmVolumeAtTimelineMs(clip, timelineMs) {
...
const IMAGE_MAX_SCALE = 1;
const IMAGE_LAYER_Z = 10;
const TELOP_LAYER_Z = 1e3;
const OVERLAY_LAYER_Z = 2e3;
function imageClipZIndex(arrayIndex) {
  return IMAGE_LAYER_Z + Math.max(0, arrayIndex);
}
const imageOverlay_clamp = (value, low, high) => Math.max(low, Math.min(high, value));
const toPercent = (ratio) => `${Number((ratio * 100).toFixed(4))}%`;
function clampImageScale(scale) {
  return imageOverlay_clamp(scale, IMAGE_MIN_SCALE, IMAGE_MAX_SCALE);
}
function normalizeImageTrack(raw) {
  if (!Array.isArray(raw)) return [];
  const clips = [];
  for (const entry of raw) {
    if (!entry || typeof entry !== "object") continue;
    ...
    clips.push({
      ...
      start_ms: Math.max(0, Math.round(startMs)),
      end_ms: Math.round(endMs),
      x: Number.isFinite(x) ? imageOverlay_clamp(x, 0, 1) : IMAGE_DEFAULT_X,
      y: Number.isFinite(y) ? imageOverlay_clamp(y, 0, 1) : IMAGE_DEFAULT_Y,
      scale: Number.isFinite(scale) ? clampImageScale(scale) : IMAGE_DEFAULT_SCALE,
      opacity: Number.isFinite(opacity) ? imageOverlay_clamp(opacity, 0, 1) : IMAGE_DEFAULT_OPACITY
    });
  }
  return clips;
}
function imageOverlayStyle(clip) {
  return {
    position: "absolute",
    ...
    opacity: imageOverlay_clamp(clip.opacity, 0, 1)
  };
}

;// ./src/lib/opTimeline.ts

const OP_PATTERNS = ["title_card", "highlight_teaser", "question_hook"];
const OP_DECORATIONS = ["flash_pop", "cinema_bars", "color_wipe", "neon_frame"];
const DEFAULT_OP_DECORATION = "flash_pop";
const OP_TEXT_ANIMATIONS = ["slide_left", "slide_up", "stamp"];
const DEFAULT_OP_TEXT_ANIMATION = "slide_left";
const OP_NEON_COLOR = "#3DE8FF";
function normalizeOpDecoration(raw) {
  return typeof raw === "string" && OP_DECORATIONS.includes(raw) ? raw : DEFAULT_OP_DECORATION;
}
function normalizeOpTextAnimation(raw) {
  return typeof raw === "string" && OP_TEXT_ANIMATIONS.includes(raw) ? raw : DEFAULT_OP_TEXT_ANIMATION;
}
const OP_CLIP_DISPLAYS = (/* unused pure expression or super */ null && (["hook", "verbatim"]));
const OP_CLIP_ROLES = ["hook_open", "punch", "cliffhanger"];
const OP_HOOK_KEYWORD_COLORS = ["yellow", "red", "white"];
const DEFAULT_OP_ACCENT_COLOR = "#16305E";
function normalizeOpClipDisplay(raw, hookText) {
  if (raw === "hook" || raw === "verbatim") {
    return raw === "hook" && !hookText ? "verbatim" : raw;
  }
  return hookText ? "hook" : "verbatim";
}
function normalizeOpHookKeywordColor(raw) {
  return typeof raw === "string" && OP_HOOK_KEYWORD_COLORS.includes(raw) ? raw : "yellow";
}
function normalizeOpClipRole(raw) {
  return typeof raw === "string" && OP_CLIP_ROLES.includes(raw) ? raw : "punch";
}
function opHookLines(hookText) {
  return hookText.replace(/\r\n/g, "\n").replace(/\r/g, "\n").split("\n").map((line) => line.trim()).filter((line) => line.length > 0).slice(0, 2);
}
function opHookSegments(line, keyword) {
...
function hookLineWeight(line) {
  let weight = 0;
  for (const ch of line) {
    weight += ch.charCodeAt(0) > 127 ? 1 : 0.55;
  }
  return weight;
}
function opHookFontPx(lines, width, height) {
...
function normalizeOpData(raw) {
  ...
  if (Array.isArray(source.highlight_cuts)) {
    for (const entry of source.highlight_cuts) {
      if (!entry || typeof entry !== "object") continue;
  ...
  return {
    ...
    accent_color: isNonEmptyString(source.accent_color) ? source.accent_color : DEFAULT_OP_ACCENT_COLOR,
    sfx_hit: isNonEmptyString(source.sfx_hit) ? source.sfx_hit : null,
    sfx_transition: isNonEmptyString(source.sfx_transition) ? source.sfx_transition : null,
...
function opTitleCardPhases(durationFrames, fps) {
...
function opQuestionHookPhases(durationFrames, fps) {
...
function opTeaserClipFrames(clips, fps) {
  const result = [];
  let cursor = 0;
  for (const clip of clips) {
    const frames = Math.max(1, Math.round((clip.end_ms - clip.start_ms) / 1e3 * fps));
    result.push({ clip, from: cursor, durationInFrames: frames });
    cursor += frames;
  }
  return result;
}
function opTeaserTitleFrame(durationFrames, fps) {
  return Math.max(0, durationFrames - Math.round(fps * 1.4));
}
function opClipTelopTiming(durationInFrames, fps) {
...
function opClipTransitionFrames(decoration, fps) {
  switch (decoration) {
    case "color_wipe":
...
const OP_COLOR_WIPE_BAR_RATIO = 0.12;
function opDecorationHasEndTitle(decoration) {
  return decoration !== "color_wipe";
}
function opSfxVolume(timelineSfxVolume) {
...
const MAX_PUNCH_SCALE = 1.2;
function normalizePunchIn(rawScale, rawOrigin) {
  const scale = Number(rawScale);
  if (!Number.isFinite(scale) || scale <= 1 || scale > MAX_PUNCH_SCALE) return null;
...
const SFX_IDS = (/* unused pure expression or super */ null && (["don", "shakin", "pon", "jan", "hyu", "teen"]));
const SFX_MIN_INTERVAL_MS = 5e3;
const DEFAULT_SFX_VOLUME = 0.25;
function resolveTelopSfxId(telop, style) {
  if (telop.sfx !== void 0) {
    if (typeof telop.sfx === "string" && telop.sfx && telop.sfx !== "none") return telop.sfx;
    return null;
  }
  const presetSfx = style == null ? void 0 : style.sfx;
  if (typeof presetSfx === "string" && presetSfx && presetSfx !== "none") return presetSfx;
  return null;
}
function isRepeatedSfx(prevSlotSfxId, sfxId) {
  return !!prevSlotSfxId && prevSlotSfxId === sfxId;
}
function sanitizeSfxVolume(value) {
  const volume = Number(value);
  if (!Number.isFinite(volume)) return DEFAULT_SFX_VOLUME;
  return Math.max(0, Math.min(1, volume));
}
function telopStartSeconds(telop, words) {
  if (typeof telop.start === "number" && typeof telop.end === "number" && telop.end > telop.start) {
    return telop.start;
  }
...
function computeSfxEvents(input) {
  var _a, _b, _c;
  ...
  for (const cut of input.cuts) {
    ...
    if (!((_a = voiceCut == null ? void 0 : voiceCut.telops) == null ? void 0 : _a.length)) continue;
    const words = ((_b = voiceCut.voice) == null ? void 0 : _b.words) ?? [];
    const cutStartMs = Number(((_c = cut.timeline) == null ? void 0 : _c.start_ms) ?? 0);
    for (const telop of voiceCut.telops) {
      ...
      candidates.push({
        frame: Math.round((cutStartMs + startSec * 1e3) / 1e3 * input.fps),
        sfxId,
  ...
  const minIntervalFrames = minIntervalMs / 1e3 * input.fps;
  const events = [];
  let lastFrame = Number.NEGATIVE_INFINITY;
  let prevSlotSfxId = null;
  for (const candidate of candidates) {
    const repeated = isRepeatedSfx(prevSlotSfxId, candidate.sfxId);
    prevSlotSfxId = candidate.sfxId;
...
;// ./src/lib/videoEffects.ts

const PINCH_EDGE_MS = 150;
const ZOOM_EASE_MS = 500;
const DIM_EDGE_MS = 300;
const VIDEO_EFFECT_SFX_VOLUME = 0.3;
const DEFAULT_PINCH_SCALE = 0.9;
const DEFAULT_PINCH_BRIGHTNESS = 0.6;
const DEFAULT_ZOOM_SCALE = 1.25;
const DEFAULT_ZOOM_FOCUS = { x: 0.5, y: 0.35 };
const DEFAULT_DIM_OPACITY = 0.5;
const DEFAULT_FACE_ZOOM_SCALE = 1.15;
const FACE_ZOOM_FALLBACK_FOCUS = { x: 0.5, y: 0.35 };
const DEFAULT_SLOW_PUSH_SCALE = 1.06;
const VIDEO_EFFECT_TYPES = ["pinch", "zoom", "dim", "face_zoom", "slow_push"];
function videoEffects_clamp01(value) {
  return Math.max(0, Math.min(1, value));
}
function normalizeVideoEffects(raw) {
  if (!Array.isArray(raw)) return [];
  const effects = [];
  for (const item of raw) {
    ...
    const readFocus = (fallback) => {
      const focus = params.focus && typeof params.focus === "object" ? params.focus : {};
      const focusX = Number(focus.x);
      const focusY = Number(focus.y);
      return {
        x: Number.isFinite(focusX) ? videoEffects_clamp01(focusX) : fallback.x,
        y: Number.isFinite(focusY) ? videoEffects_clamp01(focusY) : fallback.y
      };
    };
    if (effectType === "pinch") {
      effect.params.scale = Number.isFinite(scale) && scale >= 0.5 && scale <= 1 ? scale : DEFAULT_PINCH_SCALE;
      const brightness = Number(params.brightness);
      effect.params.brightness = Number.isFinite(brightness) && brightness >= 0 && brightness <= 1 ? brightness : DEFAULT_PINCH_BRIGHTNESS;
      const sfx = entry.sfx;
      if (typeof sfx === "string" && sfx) effect.sfx = sfx;
    } else if (effectType === "zoom") {
      effect.params.scale = Number.isFinite(scale) && scale >= 1 && scale <= 2 ? scale : DEFAULT_ZOOM_SCALE;
      effect.params.focus = readFocus(DEFAULT_ZOOM_FOCUS);
    } else if (effectType === "dim") {
      const opacity = Number(params.opacity);
      effect.params.opacity = Number.isFinite(opacity) && opacity > 0 && opacity <= 0.7 ? opacity : DEFAULT_DIM_OPACITY;
    } else if (effectType === "face_zoom") {
      effect.params.scale = Number.isFinite(scale) && scale >= 1 && scale <= 1.5 ? scale : DEFAULT_FACE_ZOOM_SCALE;
      effect.params.focus = readFocus(FACE_ZOOM_FALLBACK_FOCUS);
    } else {
      effect.params.scale = Number.isFinite(scale) && scale >= 1 && scale <= 1.2 ? scale : DEFAULT_SLOW_PUSH_SCALE;
    }
    effects.push(effect);
  }
...
function activeVideoEffectAt(effects, tMs) {
...
function easeInOut01(u) {
  const t = videoEffects_clamp01(u);
  return t * t * (3 - 2 * t);
}
function easeOut01(u) {
  const t = videoEffects_clamp01(u);
  return 1 - Math.pow(1 - t, 3);
}
function videoEffectStyle(effect, tMs) {
  ...
  if (effect.type === "pinch") {
    ...
    const progress2 = edgeMs > 0 ? easeInOut01(Math.min((tMs - effect.start_ms) / edgeMs, (effect.end_ms - tMs) / edgeMs)) : 1;
    const scale2 = 1 + (effect.params.scale - 1) * progress2;
    const brightness = 1 + ((effect.params.brightness ?? DEFAULT_PINCH_BRIGHTNESS) - 1) * progress2;
    return {
  ...
  if (effect.type === "dim") {
    ...
    const progress2 = edgeMs > 0 ? easeInOut01(Math.min((tMs - effect.start_ms) / edgeMs, (effect.end_ms - tMs) / edgeMs)) : 1;
    const opacity = (effect.params.opacity ?? DEFAULT_DIM_OPACITY) * progress2;
    return {
      transform: "none",
      transformOrigin: "center center",
  ...
  if (effect.type === "face_zoom") {
    const focus2 = effect.params.focus ?? FACE_ZOOM_FALLBACK_FOCUS;
    const progress2 = easeInOut01((tMs - effect.start_ms) / (effect.end_ms - effect.start_ms));
    const scale2 = 1 + (effect.params.scale - 1) * progress2;
    return {
      transform: `scale(${scale2})`,
      transformOrigin: `${focus2.x * 100}% ${focus2.y * 100}%`
    };
  }
  if (effect.type === "slow_push") {
    const progress2 = videoEffects_clamp01((tMs - effect.start_ms) / (effect.end_ms - effect.start_ms));
    const scale2 = 1 + (effect.params.scale - 1) * progress2;
    return {
      transform: `scale(${scale2})`,
      transformOrigin: "center center"
...
;// ./src/lib/videoFraming.ts

const FRAMING_CROP_MAX = 0.45;
const FRAMING_SCALE_MIN = 0.2;
const FRAMING_SCALE_MAX = 4;
const FRAMING_OFFSET_MAX = 1;
const FRAMING_IDENTITY_EPSILON = 1e-6;
const IDENTITY_VIDEO_FRAMING = {
  transform: { scale: 1, x: 0, y: 0 },
  crop: { left: 0, top: 0, right: 0, bottom: 0 }
};
const videoFraming_clamp = (value, low, high) => Math.max(low, Math.min(high, value));
const clampedNumber = (raw, low, high, fallback) => {
  const value = Number(raw);
  return Number.isFinite(value) ? videoFraming_clamp(value, low, high) : fallback;
};
function normalizeVideoFraming(raw) {
  ...
  const entry = raw;
  const transform = entry.transform && typeof entry.transform === "object" ? entry.transform : {};
  const crop = entry.crop && typeof entry.crop === "object" ? entry.crop : {};
  return {
    transform: {
...
function isIdentityFraming(framing) {
  const near = (value, target) => Math.abs(value - target) < FRAMING_IDENTITY_EPSILON;
  return near(framing.transform.scale, 1) && near(framing.transform.x, 0) && near(framing.transform.y, 0) && near(framing.crop.left, 0) && near(framing.crop.top, 0) && near(framing.crop.right, 0) && near(framing.crop.bottom, 0);
}
function videoFramingLayout({
  canvasWidth,
  canvasHeight,
  sourceWidth,
  sourceHeight,
  ...
  const fullCanvas = { left: 0, top: 0, width: canvasWidth || 0, height: canvasHeight || 0 };
...
const resolveVideoSrc = (filePath) => {
  ...
  if (filePath.startsWith("/segments/") || filePath.startsWith("segments/")) {
    ...
    return (0,esm/* staticFile */.dQ)(clean);
  }
  return filePath;
};

;// ./src/compositions/OpSequence.tsx
...
const OP_TITLE_FONT_FAMILY = '"GenEi Gothic N U-KL", "Dela Gothic One", "Zen Kaku Gothic Antique", "Hiragino Kaku Gothic ProN", sans-serif';
const OP_SUB_FONT_FAMILY = '"Zen Kaku Gothic Antique", "Hiragino Kaku Gothic ProN", "Hiragino Sans", "Meiryo", sans-serif';
const OP_ACCENT_YELLOW = "#FFC400";
const stampTransform = (frame, startFrame, fps) => {
  const localFrame = frame - startFrame;
...
const fadeOpacity = (frame, startFrame, durationFrames) => (0,esm/* interpolate */.GW)(frame, [startFrame, startFrame + durationFrames], [0, 1], {
  extrapolateLeft: "clamp",
  extrapolateRight: "clamp"
});
const OutroFade = ({ fromFrame, totalFrames }) => {
  const frame = (0,esm/* useCurrentFrame */.UC)();
  const opacity = (0,esm/* interpolate */.GW)(frame, [fromFrame, totalFrames - 1], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  if (opacity <= 0) return null;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: "#000", opacity } });
};
const OpSfx = ({
  frame,
  sfxId,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Sequence */.gd, { durationInFrames: Math.max(1, Math.ceil(fps * 1.2)), from: frame, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Audio */.fP, { src: (0,esm/* staticFile */.dQ)(`sfx/${sfxId}.wav`), volume }) });
};
const TitleCardOp = ({ op, sfxVolume }) => {
  const frame = (0,esm/* useCurrentFrame */.UC)();
  const { fps, width, height } = (0,esm/* useVideoConfig */.Bk)();
  const totalFrames = Math.max(1, Math.round(op.duration_ms / 1e3 * fps));
  ...
  const barProgress = (0,esm/* spring */.oz)({
    frame: Math.max(0, frame - phases.titleFrame - 3),
    fps,
    config: { damping: 200 },
    durationInFrames: Math.round(fps * 0.5)
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: op.accent_color }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm/* AbsoluteFill */.H1,
      {
        style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { style: { justifyContent: "center", alignItems: "center" }, children: [
      op.title && /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        "div",
        {
          style: {
          ...
          children: [
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              ...
              {
                style: {
                  height: Math.max(3, Math.round(height * 8e-3)),
      ...
      op.catch_copy && /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
          ...
          children: op.catch_copy
        }
      )
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(OutroFade, { fromFrame: phases.fadeOutFrame, totalFrames }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(OpSfx, { fps, frame: phases.titleFrame, sfxId: op.sfx_hit, volume: sfxVolume }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(OpSfx, { fps, frame: phases.fadeOutFrame, sfxId: op.sfx_transition, volume: sfxVolume })
  ] });
};
const HOOK_KEYWORD_COLORS = {
...
function hookOutlineShadow(px, color) {
  const offsets = [
    [px, 0],
    [-px, 0],
    [0, px],
...
const HookWordLayer = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { pointerEvents: "none" }, children: lines.map((line, lineIndex) => {
          ...
          "div",
          {
            ...
            children: segments.map((segment, segmentIndex) => {
              ...
              return /* @__PURE__ */ (0,jsx_runtime.jsx)(
                ...
                `hook_seg_${segmentIndex}`
              );
            })
          }
        )
      },
      `hook_line_${lineIndex}`
    );
  }) });
};
const ClipFlash = () => {
  const localFrame = (0,esm/* useCurrentFrame */.UC)();
  const opacity = (0,esm/* interpolate */.GW)(localFrame, [0, 2], [0.55, 0], { extrapolateRight: "clamp" });
  if (opacity <= 0) return null;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: "#FFFFFF", opacity } });
};
const ClipColorWipe = ({ color, durationInFrames }) => {
  const localFrame = (0,esm/* useCurrentFrame */.UC)();
  const progress = (0,esm/* interpolate */.GW)(localFrame, [0, durationInFrames], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  if (progress >= 1) return null;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { overflow: "hidden" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
        position: "absolute",
...
const CinemaBarsLayer = ({ clipLabel }) => {
  const { height, width } = (0,esm/* useVideoConfig */.Bk)();
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { style: { pointerEvents: "none" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: 0, left: 0, right: 0, height: barHeight, backgroundColor: "#000" } }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", bottom: 0, left: 0, right: 0, height: barHeight, backgroundColor: "#000" } }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { ...labelStyle, top: Math.round(barHeight * 0.34), left: Math.round(width * 0.03) }, children: "OPENING" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
...
const NeonFrameLayer = () => {
  ...
  const borderWidth = Math.max(3, Math.round(height * 5e-3));
  const glow = Math.round(height * 0.018);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { pointerEvents: "none" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
        position: "absolute",
...
const ColorWipeBarLayer = ({ accentColor, title }) => {
  const { height } = (0,esm/* useVideoConfig */.Bk)();
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { pointerEvents: "none" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      ...
      children: title && /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            fontFamily: OP_TITLE_FONT_FAMILY,
...
const zoomInTransform = (localFrame, durationInFrames) => {
  const progress = (0,esm/* interpolate */.GW)(localFrame, [0, durationInFrames], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  if (progress >= 1) return void 0;
  return `scale(${1.28 - 0.28 * progress})`;
};
const ClipTransition = ({ decoration, accentColor }) => {
  const { fps } = (0,esm/* useVideoConfig */.Bk)();
  if (decoration === "color_wipe") {
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(ClipColorWipe, { color: accentColor, durationInFrames: opClipTransitionFrames(decoration, fps) });
  }
  if (decoration === "neon_frame") return null;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(ClipFlash, {});
};
const ZoomableClipVideo = ({
  ...
  const localFrame = (0,esm/* useCurrentFrame */.UC)();
  const { fps, width: canvasWidth, height: canvasHeight } = (0,esm/* useVideoConfig */.Bk)();
  const transform = (decoration === "neon_frame" && withZoom ? zoomInTransform(localFrame, opClipTransitionFrames(decoration, fps)) : void 0) ?? `scale(${opClipSlowZoomScale(localFrame, durationInFrames).toFixed(4)})`;
  if (videoFramingContext) {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { transform, transformOrigin: "center center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm/* OffthreadVideo */.pe,
          {
            ...
            startFrom: Math.round(clip.start_ms / 1e3 * fps),
            style: {
              position: "absolute",
...
const HighlightTeaserOp = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: "#000" }, children: [
    clips.map(({ clip, from, durationInFrames }, index) => {
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Sequence */.gd, { durationInFrames, from, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ZoomableClipVideo,
          {
            clip,
        ...
        index > 0 && /* @__PURE__ */ (0,jsx_runtime.jsx)(ClipTransition, { accentColor: op.accent_color, decoration }),
        showHook && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          HookWordLayer,
          {
        ...
        !showHook && clip.text && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          Telop,
          {
    ...
    decoration === "cinema_bars" && /* @__PURE__ */ (0,jsx_runtime.jsx)(CinemaBarsLayer, { clipLabel: String(activeClipIndex + 1).padStart(2, "0") }),
    decoration === "color_wipe" && /* @__PURE__ */ (0,jsx_runtime.jsx)(ColorWipeBarLayer, { accentColor: op.accent_color, title: op.title }),
    decoration === "neon_frame" && /* @__PURE__ */ (0,jsx_runtime.jsx)(NeonFrameLayer, {}),
    showEndTitle && /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { style: { justifyContent: "center", alignItems: "center" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: "rgba(0,0,0,0.55)", opacity: title.opacity } }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            ...
            borderBottom: `${Math.max(3, Math.round(height * 8e-3))}px solid ${OP_ACCENT_YELLOW}`,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(OpSfx, { fps, frame: titleFrame, sfxId: op.sfx_hit, volume: sfxVolume })
  ] });
};
const QuestionHookOp = ({ op, sfxVolume }) => {
  const frame = (0,esm/* useCurrentFrame */.UC)();
  const { fps, width, height } = (0,esm/* useVideoConfig */.Bk)();
  const totalFrames = Math.max(1, Math.round(op.duration_ms / 1e3 * fps));
    ...
    esm/* AbsoluteFill */.H1,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { style: { justifyContent: "center", alignItems: "center" }, children: [
          ...
          op.title && /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                opacity: title.opacity,
...
const OpSequence = ({
  ...
  switch (op.pattern) {
    case "title_card":
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(TitleCardOp, { op, sfxVolume });
    ...
    case "question_hook":
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(QuestionHookOp, { op, sfxVolume });
  }
};

;// ./src/compositions/CatCutComposition.tsx
...
const CutVideoWithEffects = ({ cut, fps, videoFit, framing, effects, videoFraming, sourceWidth, sourceHeight }) => {
  const frame = (0,esm/* useCurrentFrame */.UC)();
  const { width: canvasWidth, height: canvasHeight } = (0,esm/* useVideoConfig */.Bk)();
  const tMs = cut.timeline.start_ms + frame / fps * 1e3;
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm/* AbsoluteFill */.H1,
    {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: punch ? punchInStyle(punch) : void 0, children: videoFraming ? (
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                esm/* OffthreadVideo */.pe,
                {
                  ...
                  startFrom: Math.round(cut.video.start_ms / 1e3 * fps),
                  style: {
                    position: "absolute",
                    left: layout.videoRect.left - layout.cropRect.left,
                    top: layout.videoRect.top - layout.cropRect.top,
        ...
        esm/* OffthreadVideo */.pe,
        {
          ...
          style: {
            ...
            transform: framing.scale !== 1 || framing.offset_y !== 0 ? `scale(${framing.scale}) translateY(${framing.offset_y * 100}%)` : void 0,
            transformOrigin: "center center"
          }
        }
      ) })
...
const CatCutComposition = ({
  timeline,
  voice_data,
  meta
}) => {
  const { fps } = (0,esm/* useVideoConfig */.Bk)();
  const voiceCutMap = /* @__PURE__ */ new Map();
  for (const vc of voice_data.cuts) {
    voiceCutMap.set(vc.id, vc);
  }
  const framing = timeline.framing ?? { scale: 1, offset_y: 0 };
  ...
  const opFrames = op ? Math.max(1, Math.round(op.duration_ms / 1e3 * fps)) : 0;
  ...
  const sourceWidth = Number(meta == null ? void 0 : meta.source_width) || 0;
  const sourceHeight = Number(meta == null ? void 0 : meta.source_height) || 0;
  const opFramingContext = videoFraming ? { framing: videoFraming, sourceWidth, sourceHeight } : null;
  const totalFrames = Math.round(
    timeline.total_duration_ms / 1e3 * fps
  );
  const startFrames = timeline.cuts.map(
    (c) => Math.round(c.timeline.start_ms / 1e3 * fps)
  );
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { style: { backgroundColor: "#000" }, children: [
    op && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Sequence */.gd, { durationInFrames: opFrames, from: 0, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      OpSequence,
      {
        op,
    ...
    timeline.cuts.map((cut, i) => {
      ...
      const durationFrames = i < startFrames.length - 1 ? startFrames[i + 1] - startFrame : totalFrames - startFrame;
      const voiceCut = voiceCutMap.get(cut.cut_id);
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        esm/* Sequence */.gd,
        {
          from: startFrame,
          durationInFrames: durationFrames,
          children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm/* AbsoluteFill */.H1, { children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              CutVideoWithEffects,
              {
                cut,
            ...
            voiceCut && voiceCut.telops.length > 0 && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { zIndex: TELOP_LAYER_Z }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              Telop,
              {
    ...
    imageClips.map((clip, index) => {
      const fromFrame = Math.round(clip.start_ms / 1e3 * fps);
      const clipFrames = Math.max(1, Math.round((clip.end_ms - clip.start_ms) / 1e3 * fps));
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        esm/* Sequence */.gd,
        {
          ...
          children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Img */.E9, { src: resolveVideoSrc(clip.file), style: imageOverlayStyle(clip) })
        },
        `image_${clip.id}`
      );
    }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* AbsoluteFill */.H1, { style: { zIndex: OVERLAY_LAYER_Z }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Overlays, { overlays: timeline.overlays, styles: timeline.telop_styles }) }),
    bgmClips.map((clip) => {
      const fromFrame = Math.round(clip.start_ms / 1e3 * fps);
      const clipFrames = Math.max(1, Math.round((clip.end_ms - clip.start_ms) / 1e3 * fps));
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Sequence */.gd, { durationInFrames: clipFrames, from: fromFrame, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        esm/* Audio */.fP,
        {
          src: resolveVideoSrc(clip.file),
          volume: (frame) => bgmVolumeAtMs(clip, frame / fps * 1e3)
        }
      ) }, `bgm_${clip.id}`);
    }),
    sfxVolume > 0 && sfxEvents.map((event) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm/* Sequence */.gd,
      {
        durationInFrames: Math.max(1, Math.ceil(fps * 1.2)),
        from: event.frame,
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm/* Audio */.fP, { src: (0,esm/* staticFile */.dQ)(`sfx/${event.sfxId}.wav`), volume: sfxVolume })
      },
      `sfx_${event.telopId}_${event.frame}`
    )),
    sfxVolume > 0 && videoEffects.filter((effect) => effect.type === "pinch" && effect.sfx).map((effect) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm/* Sequence */.gd,
      {
        durationInFrames: Math.max(1, Math.ceil(fps * 2)),
        from: Math.round(effect.start_ms / 1e3 * fps),
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm/* Audio */.fP,
          {
            src: (0,esm/* staticFile */.dQ)(`sfx/${effect.sfx}.wav`),
...
const CORE_FONT_FAMILIES = /* @__PURE__ */ new Set([
  "Zen Kaku Gothic Antique",
  // Telop.tsx / overlayStyles.ts の既定スタック
  "Dela Gothic One",
  // OpSequence.tsx
  "GenEi Gothic N U-KL"
  // OpSequence.tsx
]);
const inputPropsForFonts = (0,esm/* getInputProps */.ti)();
...
const fontsToLoad = isRenderMode ? localFonts.filter(
  ({ family }) => CORE_FONT_FAMILIES.has(family) || propsJsonForFonts.includes(family)
) : localFonts;
const FONT_FETCH_TIMEOUT_MS = 5e3;
const FONT_FETCH_RETRIES = 2;
const FONT_HARD_DEADLINE_MS = 12e3;
async function fetchAndAddFont(family, url, weight) {
  let lastError = null;
...
function loadFontRobust(family, url, weight) {
  const handle = (0,esm/* delayRender */.IH)(`Loading font ${family} (${url})`, {
    ...
    timeoutInMilliseconds: FONT_HARD_DEADLINE_MS + 8e3,
    retries: 4
  });
  let done = false;
  const finish = (error) => {
...
const startFontLoading = () => {
  fontsToLoad.forEach(({ family, url, weight }) => {
    loadFontRobust(family, (0,esm/* staticFile */.dQ)(url), weight);
  });
};
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm/* Composition */.BO,
    {
      ...
      calculateMetadata: async ({ props }) => {
        var _a, _b;
        const ip = (0,esm/* getInputProps */.ti)();
        if (ip.timeline && ip.timeline.cuts && ip.timeline.cuts.length > 0) {
          const meta = ip.meta || {};
          const fps = ip.timeline.fps || 30;
          return {
            durationInFrames: Math.ceil(ip.timeline.total_duration_ms / 1e3 * fps),
            fps,
            width: ip.width || meta.display_width || 1280,
            height: ip.height || meta.display_height || 720,
            props: {
        ...
        try {
          const res = await fetch(`${(0,esm/* staticFile */.dQ)("composition-v2.json")}?t=${Date.now()}`, { cache: "no-store" });
          if (!res.ok) throw new Error(`HTTP ${res.status}`);
          const data = await res.json();
          const meta = data.meta || {};
          const fps = ((_a = data.timeline) == null ? void 0 : _a.fps) || 30;
          const totalMs = ((_b = data.timeline) == null ? void 0 : _b.total_duration_ms) || 3e4;
          return {
            durationInFrames: Math.ceil(totalMs / 1e3 * fps),
            fps,
            width: meta.display_width || 1280,
            height: meta.display_height || 720,
            props: {
...
(0,esm/* registerRoot */.eU)(RemotionRoot);
...
remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.CSSUtils.injectCSS(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.CSSUtils.makeDefaultPreviewCSS(null, "#1f2428"));
...
var DelayedSpinner = () => {
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_2__/* .AbsoluteFill */ .H1, {
    style: {
      justifyContent: "center",
      alignItems: "center",
      fontSize: 13,
...
var GetVideoComposition = ({ state }) => {
  const { compositions, currentCompositionMetadata, canvasContent } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.CompositionManager);
  const { setCanvasContent } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.CompositionSetters);
  const portalContainer = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const { delayRender, continueRender } = (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .useDelayRender */ .dB)();
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    current.appendChild(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.portalNode());
    continueRender(handle);
    return () => {
      current.removeChild(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.portalNode());
    };
...
var waitForRootHandle = (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .delayRender */ .IH)("Loading root component - See https://remotion.dev/docs/troubleshooting/loading-root-component if you experience a timeout", {
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "composition") {
    const markup = /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.CompositionManagerProvider, {
      ...
      initialCompositions: [],
      children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.RemotionRootContexts, {
        frameState: null,
        ...
        children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.RenderAssetManagerProvider, {
          collectAssets: null,
          children: [
  ...
  if (bundleMode.type === "evaluation") {
    const markup = /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.CompositionManagerProvider, {
      ...
      children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.RemotionRootContexts, {
        ...
        audioLatencyHint: window.remotion_audioLatencyHint ?? "playback",
        visualModeEnabled: false,
        children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.RenderAssetManagerProvider, {
          collectAssets: null,
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(750), __webpack_require__.e(183), __webpack_require__.e(226)]).then(__webpack_require__.bind(__webpack_require__, 9183)).then(({ StudioInternals }) => {
...
remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.waitForRoot((Root) => {
  renderContent(Root);
  (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .continueRender */ ._8)(waitForRootHandle);
});
var setBundleModeAndUpdate = (state) => {
  setBundleMode(state);
  const delay = (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .delayRender */ .IH)("Waiting for root component to load - See https://remotion.dev/docs/troubleshooting/loading-root-component if you experience a timeout");
  remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.waitForRoot((Root) => {
    renderContent(Root);
    requestAnimationFrame(() => {
      (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .continueRender */ ._8)(delay);
    });
  });
};
if (typeof window !== "undefined") {
  const getUnevaluatedComps = () => {
    if (!remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.getRoot()) {
    ...
    if (!remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.compositionsRef.current) {
      throw new Error("Unexpectedly did not have a CompositionManager");
    }
    const compositions = remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.compositionsRef.current.getCompositions();
    const canSerializeDefaultProps = getCanSerializeDefaultProps(compositions);
    if (!canSerializeDefaultProps) {
      remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.Log.warn({ logLevel: window.remotion_logLevel ?? "info", tag: null }, "defaultProps are too big to serialize - trying to find the problematic composition...");
      remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.Log.warn({ logLevel: window.remotion_logLevel ?? "info", tag: null }, "Serialization:", compositions);
      ...
      remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.Log.warn({ logLevel: window.remotion_logLevel ?? "info", tag: null }, "Could not single out a problematic composition -  The composition list as a whole is too big to serialize.");
  ...
  window.getStaticCompositions = () => {
    ...
    const inputProps = typeof window === "undefined" || (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .getRemotionEnvironment */ .P1)().isPlayer ? {} : (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .getInputProps */ .ti)() ?? {};
    return Promise.all(compositions.map(async (c) => {
      const handle = (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .delayRender */ .IH)(`Running calculateMetadata() for composition ${c.id}. If you didn't want to evaluate this composition, use "selectComposition()" instead of "getCompositions()"`);
      const originalProps = {
        ...c.defaultProps ?? {},
        ...inputProps ?? {}
      };
      const comp = remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.resolveVideoConfig({
      ...
      (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .continueRender */ ._8)(handle);
  ...
  window.remotion_calculateComposition = async (compId) => {
    ...
    const handle = (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .delayRender */ .IH)(`Running the calculateMetadata() function for composition ${compId}`);
    const inputProps = typeof window === "undefined" || (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .getRemotionEnvironment */ .P1)().isPlayer ? {} : (0,remotion__WEBPACK_IMPORTED_MODULE_2__/* .getInputProps */ .ti)() ?? {};
    const originalProps = {
      ...selectedComp.defaultProps ?? {},
      ...inputProps ?? {}
    };
    const prom = await Promise.resolve(remotion__WEBPACK_IMPORTED_MODULE_2__/* .Internals */ .Xp.resolveVideoConfig({
...
/* harmony export */   Bk: () => (/* binding */ useVideoConfig),
/* harmony export */   E9: () => (/* binding */ Img),
/* harmony export */   GW: () => (/* binding */ interpolate),
/* harmony export */   H1: () => (/* binding */ AbsoluteFill),
/* harmony export */   IH: () => (/* binding */ delayRender),
/* harmony export */   K_: () => (/* binding */ watchStaticFile),
/* harmony export */   OK: () => (/* binding */ useRemotionEnvironment),
/* harmony export */   P1: () => (/* binding */ getRemotionEnvironment),
/* harmony export */   UC: () => (/* binding */ useCurrentFrame),
/* harmony export */   Xp: () => (/* binding */ Internals),
/* harmony export */   Y7: () => (/* binding */ interpolateColors),
/* harmony export */   _8: () => (/* binding */ continueRender),
/* harmony export */   dB: () => (/* binding */ useDelayRender),
/* harmony export */   dQ: () => (/* binding */ staticFile),
/* harmony export */   eU: () => (/* binding */ registerRoot),
/* harmony export */   fP: () => (/* binding */ Audio),
/* harmony export */   gd: () => (/* binding */ Sequence),
/* harmony export */   oz: () => (/* binding */ spring),
/* harmony export */   pe: () => (/* binding */ OffthreadVideo),
...
/* harmony export */ });
/* unused harmony exports useCurrentScale, useBufferState, prefetch, measureSpring, getStaticFiles, cancelRender, Video, Still, Series, Loop, IFrame, Html5Video, Html5Audio, Freeze, FolderContext, Folder, Experimental, Easing, Config, Artifact, AnimatedImage */
/* unused harmony import specifier */ var useContext2;
...
/* unused harmony import specifier */ var React30;
/* unused harmony import specifier */ var React38;
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6540);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "cat-cut-remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcat_cut_remotion"] = self["webpackChunkcat_cut_remotion"] || [];
