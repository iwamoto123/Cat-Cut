#!/bin/bash
# 2026-08-22: W30(意味の塊分割・フォント拡大・縦型マッピング優先順位修正=斜め/特大/縦書き復活)
# 反映のため、既存run(20260822_120000)の step06c 以降を再実行して再レンダリングする。
set -euo pipefail
...
echo "=== step06c direction (意味の塊分割 + AI演出決定 / W30再実行) ==="
